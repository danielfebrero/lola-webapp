...
const ExploreWorstCharactersPage: React.FC<ExploreWorstCharactersPageProps> = ({
  data,
}) => {
  const title = "Explore worst characters on Fabularius AI";
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://fabularius.ai/explore/characters/worst`}
        />
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  fetchQuery += "&exploreMode=worst&exploreType=characters";
...
export default ExploreWorstCharactersPage;
